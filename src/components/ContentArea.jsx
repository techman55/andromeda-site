export default function ContentArea(props) {
    ...
    return <div className={"flex flex-row justify-evenly border-2 border-[#5243ac] rounded-xl bg-gradient-to-r from-[#333333] to-[#5243ac] p-6 m-10 mt-20 flex-wrap drop-shadow-xl"}>
